package com.gitnavi.springboot.consumer.aop.logger;

import com.gitnavi.springboot.consumer.common.GlobalVariable;
...
public class LogAspect {
	...
	@Pointcut("execution(public * com.gitnavi.springboot.consumer..controller..*.*(..))")
