package com.gitnavi.springboot.producer.aop.logger;

import com.gitnavi.springboot.producer.common.GlobalVariable;
...
public class LogAspect {
	...
	@Pointcut("execution(public * com.gitnavi.springboot.producer..controller..*.*(..))")
